# -*- coding: utf-8 -*-
content = """ลำดับ,มิติ,ชื่อ KPI,คำอธิบาย KPI (สำหรับ CEO),การแปลผลของ KPI (สำหรับ CEO),วิธีการคำนวน,วิธีการคำนวนข้อมูลที่ใช้
...
import os
base_dir = r"C:\Users\Nitchapat\Downloads\case3-ร้านกาแฟ"
output_path = os.path.join(base_dir, "KPI_Coffee_Shop_UTF8BOM.csv")
